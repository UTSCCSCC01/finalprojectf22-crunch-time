...
**Github:** https://github.com/UTSCCSCC01/finalprojectf22-crunch-time
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  - All user stories identify goal/desire and all identify why/benefit (max 2 marks) 
    ...
    Your mark: 1
    -- some user stories could use a more relevant persona than a "logged in" user
...
## Process: process.md (max 10 marks)
  ...
  - Meetings (max 2 marks)
    ...
    Your mark: 1
    -- needs its own section describing in detail what should be discussed in meetings, how it will run, etc.
